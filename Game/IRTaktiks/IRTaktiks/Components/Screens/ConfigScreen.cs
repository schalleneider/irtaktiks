...
namespace IRTaktiks.Components.Screens
{
    ...
    public class ConfigScreen : Screen
    {
		...
		public override void Initialize()
		{
            ...
            Unit fighterOne = new Unit(this.Game, game.PlayerOne, new Vector2(200, 200), new UnitAttributes(80, 10, 60, 10, 40), UnitOrientation.Left, TextureManager.Instance.KnightTexture, "Azn Flames", 11358, 758);
            ...
            Unit fighterTwo = new Unit(this.Game, game.PlayerTwo, new Vector2(800, 200), new UnitAttributes(80, 10, 60, 10, 40), UnitOrientation.Up, TextureManager.Instance.KnightTexture, "Spanker", 5012, 612);
            Unit wizardTwo = new Unit(this.Game, game.PlayerTwo, new Vector2(800, 300), new UnitAttributes(1, 1, 1, 99, 99), UnitOrientation.Down, TextureManager.Instance.KnightTexture, "Mr. Light", 1105, 3452);
